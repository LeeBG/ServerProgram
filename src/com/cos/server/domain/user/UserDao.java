...
import com.cos.server.config.DB;

public class UserDao {
	public List<User> findAll() {			//유저 목록
		String sql = "SELECT id, username, email, role FROM user ORDER BY id";
	...
	public int deleteById(int id) { 		//유저 삭제
	...
	public int findByUsername(String username) { //유저네임 중복 확인
